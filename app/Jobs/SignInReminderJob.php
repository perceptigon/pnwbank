...
class SignInReminderJob extends Job implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        {
            $message = "Hi $nation->leader, \n \nThis message is being sent to you because you have not yet signed in for this period. Please go [link=https://rnco.uk/signin]here[/link] to sign in. We need this information in order to plan properly and you must sign in to be eligible for all economic programs.";
