...
class Verify
{
    ...
    private function checkWarchest($requirement) : bool
    {
        try
        {
            ...
            {
                $this->eligible = false;
                array_push($this->errors, "You haven't signed in to the Defense Module yet. Please <a href='https://banque-lumiere.pro/signin' target='_blank'>CLICK HERE</a> to complete your defense sign in. Once finished, come back here and make another request.");
            ...
            {
                $this->eligible = false;
                array_push($this->errors, "Sorry, you don't meet the required MMR score. <a href='https://banque-lumiere.pro/defense/dashboard' target='_blank'>Click here</a> to see your MMR score.");
