...
class SignInReset extends Command
{
    ...
    {
        $json = \json_decode(file_get_contents("http://politicsandwar.com/api/alliance-members/?allianceid=7399&key=".env("PW_API_KEY")));
