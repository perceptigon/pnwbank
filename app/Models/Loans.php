...
class Loans extends Model
{
    ...
    public static function denyLoan(Request $request) : bool
    {
        ...
        $client = new PWClient();
        $client->login();
        $message = "Hi ".$loan->leader.", \n \n Your loan of $".number_format($loan->amount)." has been denied. If you would like to know why, please [link=http://rnco.uk/contact]contact us[/link].";
