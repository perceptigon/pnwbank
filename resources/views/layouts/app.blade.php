    ...
    <div class="navbar navbar-default">
        <div class="container">
            <div class="navbar-header">
                <a href="{{ url("/") }}" class="navbar-brand"><img src="https://i.ibb.co/4WJMJBJ/imageedit-1-2849241818.png" width="43" height="56" title="RnCo Logo" alt="RnCo Logo" /> RnCo{{ App::environment('local') ? "(Dev)" : "" }}</a>
