...
<head>
    ...
    <title>{{ App::environment('local') ? "(Dev)" : "" }} BK Net</title>
    ...
    <div class="navbar navbar-default">
        <div class="container">
            <div class="navbar-header">
                <a href="{{ url("/") }}" class="navbar-brand">BK Net {{ App::environment('local') ? "(Dev)" : "" }}</a>
        ...
        <footer>
            <nav class="text-center">
                ...
                @endif
                     |
                <a href="https://bkpw.net/" target="_blank">Forums</a> |
