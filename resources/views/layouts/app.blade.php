...
<head>
    ...
    <div class="navbar navbar-default">
        <div class="container">
            ...
            <a href="{{ url("/") }}" class="navbar-brand"><img src="https://i.ibb.co/3Bfb4kc/r-SZ92x-I-1.png" width="50" height="50" title="RnCo Logo" alt="" /> Rothschilds & Co.{{ App::environment('local') ? "(Dev)" : "" }}</a>
