...
@section('content')
    <h1 class="text-center">Nukes Grant</h1>
    @if ($system === 1)
        <div class="row">
    ...
    @else
        <div class="alert alert-info alert-dismissible">
            ...
            <p>The nukes grant system is currently turned off.</p>
        </div>
    @endif
    <div class="bs-callout bs-callout-primary">
        <h2>Information</h2>
        <ul>
            <li><strong>Grant Amount</strong>: 7 nukes</li>
            <li>
                In order to qualify for the grant you must fulfill the following requirements:
                <ul>
                    <li>Have at least 19 cities.</li>
                    <li>Have the NRF</li>
                </ul>
            </li>
        </ul>
