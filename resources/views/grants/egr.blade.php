...
@section('content')
    <h1 class="text-center">Emergency Gasoline Refinery Grant</h1>
    @if ($system === 1)
        <div class="row">
    ...
    @else
        <div class="alert alert-info alert-dismissible">
            ...
            <p>The EGR grant system is currently turned off.</p>
        </div>
    @endif
    <div class="bs-callout bs-callout-primary">
        <h2>Information</h2>
        <ul>
            <li>Grant Amount: $4,000,000, 125 aluminum, 125 steel</li>
            <li>
